...
public class OrderUpdateRequest {
    ...
    public OrderUpdateRequest(Integer id, Double totalPrice, Integer customerId, List<@Positive(message = "Order product ID must be a positive number") Integer> orderProductIds) {
        this.id = id;
